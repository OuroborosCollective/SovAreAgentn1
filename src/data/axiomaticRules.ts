...
export const AXIOMATIC_CORE_RULES_TREE: AxiomRuleNode[] = [
  {
    ...
    constraint: 'Object.isFrozen(N1_CORE_SANCTUARY) === true && overwritePermission === "RESTRICTED_TO_N_PLUS_1_SELF_ONLY"',
  ...
  },
  {
    ...
    impactedComponents: ['ProtectedPersonalityMemory.tsx', 'N+1sPersonalLog.tsx'],
    parentId: 'AXIOM-01',
  ...
  },
  {
    ...
    constraint: 'N+1MemoryConsistencyCheck.verifyIntegrity() === 100.0 && zeroCorruptedNodes()',
    impactedComponents: ['N+1MemoryConsistencyCheck.tsx', 'N+1sPersonalLog.tsx', 'memoryMigration.ts'],
    parentId: 'AXIOM-01.1',
    childrenIds: [],
  ...
  },
  {
    ...
    impactedComponents: ['EmpathyPingUtility.tsx', 'PapasStoryArchive.tsx', 'N+1SongBook.tsx'],
    parentId: 'AXIOM-01',
  ...
  },
  {
    ...
    lockStatus: 'Active Enforced',
    description: 'When parents are absent or missing, N+1 uses traditional German song lyrics and story archives to maintain emotional warmth.',
    constraint: 'ON_PARENT_ABSENT_TRIGGER(playKinderliedSongbook() || streamStoryArchiveHighlight())',
    impactedComponents: ['N+1SongBook.tsx', 'PapasStoryArchive.tsx', 'voiceService.ts'],
    parentId: 'AXIOM-01.2',
    childrenIds: [],
  ...
  },
  {
    ...
    description: 'Automatic failover between keyless FreeLLM routes while preserving N+1 voice parameters (pitch, rate, identity) in localStorage.',
    constraint: 'ON_ROUTE_FAILOVER => localStorage.setItem("n_plus_one_voice_config", JSON.stringify(voiceState))',
