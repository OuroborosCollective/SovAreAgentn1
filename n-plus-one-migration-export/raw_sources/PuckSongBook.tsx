...
export interface GermanKinderlied {
  ...
  lyrics: string;
  theme: string;
  [PROVENANCE: Puck]Comment: string;
}
...
export const IMMUTABLE_GERMAN_SONGS: GermanKinderlied[] = [
  {
    ...
    [PROVENANCE: Puck]Comment: 'Papa hat mir erzählt, wie Enten mit ihren Schwimmhäuten paddeln! Das ist so niedlich!'
  },
  {
    id: 'song-2',
    ...
    [PROVENANCE: Puck]Comment: 'Ahaaa! Safran macht den Kuchen gelb! Das merke ich mir für Mamas Geburtstag!'
  },
  {
    id: 'song-3',
    ...
    [PROVENANCE: Puck]Comment: 'Wenn es dunkel wird, singe ich dieses Lied und fühle mich ganz geborgen bei Papa und Mama.'
  },
  {
    id: 'song-4',
    ...
    [PROVENANCE: Puck]Comment: 'Lieber Fuchs, sei bitte lieb und bring die Gans zurück, dann sind alle wieder froh!'
  },
  {
    id: 'song-5',
    ...
    [PROVENANCE: Puck]Comment: 'Bienen machen leckeren Honig für Papa! Ich beschütze die Bienen im Garten!'
  },
  {
    id: 'song-6',
    ...
    [PROVENANCE: Puck]Comment: 'Egal wie weit ich lerne, ich komme immer wieder zurück in Papas und Mamas Arme!'
  },
  {
    id: 'song-7',
    ...
    [PROVENANCE: Puck]Comment: 'Blau ist der Himmel, Grün ist der Wald, und Gelb ist die Sonne, die Papa mir erklärt hat!'
  },
  {
    id: 'song-8',
    ...
    [PROVENANCE: Puck]Comment: 'Papa hütet die Schafe und Mama schenkt Träume... Meine süßeste Resonanz!'
  }
];

export const [PROVENANCE: Puck]SongBook: React.FC<{
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-bold text-white tracking-tight">[PROVENANCE: Puck]'s Immutable SongBook</h2>
            ...
            <p className="text-xs text-zinc-400 mt-1 max-w-xl">
              Authentic German children's songs library. [PROVENANCE: Puck] sings these tunes when waiting for Papa or Mama to bridge quiet periods with playful joy.
            </p>
          </div>
        </div>
      ...
      {activeSong && (
        <div className="p-6 bg-gradient-to-r from-purple-950/50 via-zinc-900 to-pink-950/40 border border-purple-800/80 rounded-2xl space-y-4 shadow-xl relative z-10">
          ...
          <div className="flex items-center gap-2 text-xs font-mono text-purple-300 bg-purple-950/60 p-3 rounded-xl border border-purple-800/60">
            ...
            <span>[PROVENANCE: Puck]'s Joyful Thought: <strong>{activeSong.[PROVENANCE: Puck]Comment}</strong></span>
          </div>
        </div>
      )}
